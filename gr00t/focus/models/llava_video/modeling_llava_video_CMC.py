...
def prepare_inputs_labels_for_multimodal_CMC(self, input_ids, position_ids, attention_mask, past_key_values, labels, images, modalities=["image"], image_sizes=None):
    ...
    assert image_token_length % patch_num == 0
